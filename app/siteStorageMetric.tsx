...
export default function SiteStorageMetric(props: ISiteStorageMetricProps) {
    ...
    return (
        <div className={`flex flex-row justify-between p-4 text-xl h-24 bg-slate-50 w-full items-center bg-opacity-35 border-inherit border-y-2 ${props.className ?? ''}`} style={{
            ...
            <p className="text-sm w-1/2 text-wrap">{props.siteName}</p>
